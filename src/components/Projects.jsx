...
export default function Projects() {
  const projects = [
    { title: "Neural Tasks", desc: "AI-driven task management system with predictive scheduling and smart prioritization capabilities.", tech: ["React", "Python", "TensorFlow"], link: "#" },
    { title: "Quantum Trade", desc: "High-frequency crypto trading algorithms dashboard with real-time WebGL charting.", tech: ["Three.js", "Node.js", "WebSockets"], link: "#" },
    { title: "Neon Engine", desc: "A custom lightweight 3D rendering engine built completely from scratch for web browsers.", tech: ["WebGL", "JavaScript", "GLSL"], link: "#" },
    { title: "Astro Social", desc: "Decentralized space-themed social network utilizing IPFS for secure, fast peer-to-peer data storage.", tech: ["Next.js", "Solidity", "IPFS"], link: "#" },
    { title: "Event Horizon", desc: "A black hole simulation interactive educational tool using physics equations and Raymarching.", tech: ["Three.js", "React Fiber", "Shaders"], link: "https://saoudhussaini-sudo.github.io/event-horizon/" },
    { title: "Cyber Protocol", desc: "End-to-end encrypted messaging application with self-destructing data packets.", tech: ["React Native", "Express", "Crypto"], link: "#" },
  ];
